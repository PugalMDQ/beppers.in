...
object TextUtils {
     ...
     * If the string is null then it will return underconstruction string else It will trim the string and return
     * it.
     *
     * @param str string to be prettified for display.
     * @return If the string is null then it will return underconstruction string else It will trim the string and
     * return it.
     */
