...
class ReviewListActivity : BaseActivity<ActivityReviewBinding, ReviewListNavigator>(), ReviewListNavigator {
    companion object {
    ...
    private fun rating() {
        reviewListViewModel!!.PostRating(ii!!,remarks!!.toString(),activityReviewBinding!!.editText.text.toString()).observe(this, Observer { response ->
