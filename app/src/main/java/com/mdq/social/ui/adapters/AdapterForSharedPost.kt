...
class AdapterForSharedPost (var context: Context, var trendingItem:List<DataItem>, var position:Int, var clickManager:ClickManager, var user_id:String): RecyclerView.Adapter<AdapterForSharedPost.mine>() {
