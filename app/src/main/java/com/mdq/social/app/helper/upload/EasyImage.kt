...
import com.fasttrack.attachment.helper.upload.ChooserType
import com.fasttrack.attachment.helper.upload.EASYIMAGE_LOG_TAG
...
//                if (copyImagesToPublicGalleryFolder) Files.copyFilesInSeparateThread(activity, folderName, files.map { it.file })
    ...
    class Builder(private val context: Context) {
        ...
        private var easyImageStateHandler: EasyImageStateHandler = EasyImageStateHandler
